...
@Test
public class MantaObjectOutputStreamAesCbcIT {
    ...
    public void beforeClass() throws IOException {
        ...
        properties.put("manta.encryption_algorithm", "AES256/CBC/PKCS5Padding");
    ...
    public void canUploadMuchLargerFile() throws IOException {
        ...
        AssertJUnit.assertEquals(head.getHeader("m-encrypt-cipher"), "AES256/CBC/PKCS5Padding");
