...
@Test
public class MantaObjectOutputStreamAesGcmIT {
    ...
    public void beforeClass() throws IOException {
        ...
        properties.put("manta.encryption_algorithm", "AES256/GCM/NoPadding");
    ...
    public void canUploadMuchLargerFile() throws IOException {
        ...
        AssertJUnit.assertEquals(head.getHeader("m-encrypt-cipher"), "AES256/GCM/NoPadding");
