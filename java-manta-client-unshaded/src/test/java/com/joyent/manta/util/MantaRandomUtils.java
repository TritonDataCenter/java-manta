...
/**
 * <p>This class modifies the {@link org.apache.commons.lang3.RandomUtils}
 * class such that it allows for you to specify the {@link java.util.Random}
 * instance that will produce the random values generated.</p>
 * <p>Utility library that supplements the standard {@link Random} class.</p>
 *
 */
public class MantaRandomUtils {
    /**
    ...
    /**
     * Creates a new instance with a backing {@link java.util.Random} that uses
     * the specified seed value.
     *
     * @param seed random seed
     */
    public MantaRandomUtils(final long seed) {
        this.rnd = new Random(seed);
    }

    /**
     * Creates a new instance with the specified {@link java.util.Random} instance.
     *
     * @param rnd source of randomness
     */
    public MantaRandomUtils(final Random rnd) {
        Validate.notNull(rnd);
        this.rnd = rnd;
    }
    ...
    public int nextInt(final int startInclusive, final int endExclusive) {
        ...
        return startInclusive + rnd.nextInt(endExclusive - startInclusive);
    }
     ...
     */
    public double nextDouble(final double startInclusive, final double endInclusive) {
        ...
        return startInclusive + ((endInclusive - startInclusive) * rnd.nextDouble());
    }
    ...
    public float nextFloat(final float startInclusive, final float endInclusive) {
        ...
        return startInclusive + ((endInclusive - startInclusive) * rnd.nextFloat());
    }
