...
public enum MantaErrorCode {
    ...
    ENTITY_EXISTS_ERROR("EntityAlreadyExists"),
    ...
    PRE_SIGNED_REQUEST_ERROR("InvalidQueryStringAuthentication"),
    ...
    ROOT_DIRECTORY_ERROR("OperationNotAllowedOnRootDirectory"),
    ...
    SSL_REQUIRED_ERROR("SecureTransportRequired"),
